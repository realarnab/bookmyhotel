    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{ // SecurityFilterChain --> this interface feature to apply chain of security mechanism in your project
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers("/api/v1/countries/addCountry","api/v1/countries/getAll","/api/v1/countries/deleteCountry/{id}","/api/v1/favourite","/api/v1/properties/addProperty",
                        "/api/v1/properties/deleteProperty/{id}","/api/v1/images/upload/{bucketName}/property/{propertyId}","/s3bucket/upload/file/{bucketName}","/api/v1/properties/update/{id}",
                        "/api/v1/countries/update/{id}","/api/v1/images/delete/{bucketName}/{id}").hasRole("ADMIN") //makes the url only accessible for ADMIN
                ...
                .requestMatchers("api/v1/users/profile","/api/v1/booking/addNew/{propertyId}","/api/v1/booking/getBooking",
                        ...
                        "/api/v1/reviews/update/{id}","/api/v1/favourite/all").hasAnyRole("ADMIN","USER") //makes the url accessible for ADMIN and USER
